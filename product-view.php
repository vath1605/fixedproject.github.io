        ...
        <div class="col-7">
            ...
            <?php if ($pro['original_price'] > $pro['selling_price']) { ?>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <select class="form-select shadow-none" name="order_qty">
            ...
            <div class="row">
                <div class="col-6 my-4">
                    <button type="button" class="btn btn-outline-dark w-100 py-2 fw-bold d-flex justify-content-center align-items-center">
                ...
                <div class="col-6 my-4">
                    <button type="button" class="btn btn-outline-danger w-100 py-2 fw-bold d-flex justify-content-center align-items-center">
